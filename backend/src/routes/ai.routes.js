...
import { safeUploadSingle } from "../middleware/file.middleware.js";
 ...
 * @access private
 */
router.post("/generate", current_user, safeUploadSingle('resume'), aiController.generateInterviewReport);
