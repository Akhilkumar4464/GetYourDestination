...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (success) {
      showToast('Welcome back! Loading your strategy workspace...', 'success');
      navigate('/service');
    } else {
  ...
  return (
    <div className="auth-page">
      <SEO 
        title="Sign In — GetYourDestination Executive Edition" 
          ...
          <div className="form-wrapper">
            ...
            <form onSubmit={handleSubmit} className="auth-form-body">
              ...
              <div className="demo-login-box">
                <p>Quick Evaluation Test (Pre-filled Demo):</p>
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
